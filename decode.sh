...
export KALDI_ROOT=/home/crow/projects/fl/decode.sh/kaldi
...
online2-wav-nnet3-latgen-faster \
      ...
      --acoustic-scale=1.0 --beam=13.0 --lattice-beam=6.0 --max-active=7000 \
    ...
    lattice-lmrescore-const-arpa --lm-scale=1.0 ark:- data/lang_test_rescore/G.carpa ark:- |
    lattice-align-words data/lang_test_rescore/phones/word_boundary.int exp/tdnn/final.mdl ark:- ark:- |
    lattice-to-ctm-conf --frame-shift=0.03 --acoustic-scale=1.1 ark:- - |
